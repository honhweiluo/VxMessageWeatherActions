...
public class AllConfig {
    public static final String VxAppId = "wx8d765f34fc133821";
    public static final String VxAppSecret = "06a495cac759fd743e0bb2200e665ce5";
    public static final String WeatherKey = "0fe366ab4d99f0fe5be0be7f280945f6";
    public static final String WeatherKey_HeFeng = "827e70ee15474f9199fa56e25cbed6f2";
    ...
    private static void init(){
        ...
        userList.add(getUser(
                "ohTsF6dVDv3f-8grDCdKFg-RU00A", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "dGgg2EV8--7dpbVhyOtl8fVW4MZkjZstvPuRRdu_yzY", //要给这个人发送的模板ID
                "谢姐", //咋称呼这个人
                "重庆市丰都县", //这个人的详细地址
                "重庆", //这个人在的城市
                new BirthDay(2001,1,17,true,false,"pt生日快乐！！"),                             
        ));
